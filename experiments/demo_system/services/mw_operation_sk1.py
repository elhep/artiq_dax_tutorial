...
class MicrowaveOperationSK1Service(MicrowaveOperationService):
    ...
    def init(self) -> None:
        ...
        self._sk1_pi_2_x: np.int32 = np.int32(self._microwave.turns_to_pow(self._SK1_PI_2))
        self._msk1_pi_2_x: np.int32 = np.int32(self._microwave.turns_to_pow(-self._SK1_PI_2))
        self._sk1_pi_x: np.int32 = np.int32(self._microwave.turns_to_pow(self._SK1_PI))
        self._msk1_pi_x: np.int32 = np.int32(self._microwave.turns_to_pow(-self._SK1_PI))

        self._sk1_pi_2_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 + self._SK1_PI_2))
        self._msk1_pi_2_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 - self._SK1_PI_2))
        self._sk1_pi_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 + self._SK1_PI))
        self._msk1_pi_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 - self._SK1_PI))

        self._sk1_mpi_2_x: np.int32 = np.int32(self._microwave.turns_to_pow(self._SK1_MPI_2))
        self._msk1_mpi_2_x: np.int32 = np.int32(self._microwave.turns_to_pow(-self._SK1_MPI_2))
        self._sk1_mpi_2_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 + self._SK1_MPI_2))
        self._msk1_mpi_2_y: np.int32 = np.int32(self._microwave.turns_to_pow(0.25 - self._SK1_MPI_2))

        self._sk1_pi_h: np.int32 = np.int32(self._microwave.turns_to_pow(0.125 + self._SK1_PI))
        self._msk1_pi_h: np.int32 = np.int32(self._microwave.turns_to_pow(0.125 - self._SK1_PI))
